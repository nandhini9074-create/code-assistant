...
class SearchResponse(BaseSchema):
    ...
    # Exact code change payload, if the analysis stage identified a target
    # file and a specific old_code/new_code pair.
    code_change: dict[str, Any] | None = None

    # Actual corrected/proposed code generated by the analyzer.
    suggested_code: str | None = None

    # Suggestion-only output: generated in memory, not written to repo
