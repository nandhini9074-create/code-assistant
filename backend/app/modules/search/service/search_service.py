    ...
    async def run_pipeline(
        ...
        try:
            ...
            for index, stage in enumerate(self.stages, start=1):
                ...
                print(
                    f"\n[SEARCH] Stage {index}/{len(self.stages)}: "
                    f"{stage_name}"
                )
                ...
                if (
                    ...
                    print(
                        f"[SEARCH] Skipping {stage_name} "
                        f"because early_exit is set"
                    )
                ...
                try:
                    ...
                    if context.early_exit:
                        ...
                        print(
                            f"[SEARCH] Early exit triggered by "
                            f"{stage_name}: "
                            f"{context.early_exit}"
                        )
